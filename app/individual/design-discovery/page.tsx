...
export default function DemandRadarPage() {
  ...
  return (
    <>
      <div className="bg-indigo-50 border-l-4 border-indigo-500 p-4 mb-8 rounded-r-lg animate-fade-in flex items-start gap-3">
        <Activity className="w-5 h-5 text-indigo-600 mt-0.5 shrink-0" />
        <div>
           <div className="text-sm font-semibold text-indigo-900">Decision Engine Active Workflow</div>
           <div className="text-sm text-indigo-700 mt-1">
             Your current warp is nearing completion. Evaluate these AI-recommended design options for your next cycle.
           </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }} className="animate-slide-up">
        <div>
          ...
          <p style={{ fontSize: '0.9375rem', color: '#78716C', maxWidth: '600px' }}>
            Evaluate design options and request weaving blueprints for the upcoming production cycle.
          </p>
        </div>
        <button
      ...
      {selectedTrend && (
        ...
        >
          ...
          >
            ...
            <div style={{ backgroundColor: '#F9F6F0', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#FFFFFF', overflow: 'hidden', minHeight: 0 }}>
              ...
              {activeTrend && !isLoading && (
                <div style={{ padding: '1.25rem', borderTop: '1px solid #F0ECE5', backgroundColor: '#FDFCF9' }}>
                  ...
                  >
                    <CheckCircle2 size={16} /> Approve Next Blueprint
                  </button>
                </div>
              )}
            </div>
